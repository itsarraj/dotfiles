    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Fuzzy find all the symbols in your current workspace.ini
      ...
      require('java').setup {
        -- Custom nvim-java specific setup can go here
        -- Example: cmd = { 'java-lsp.sh' },
      }

      -- Setup the LSP for jdtls (Java language server)
      require('lspconfig').jdtls.setup {
        -- Custom LSP configurations for jdtls, if any
        -- Example: cmd = { 'java-lsp' },
      }
      ...
      require('mason-lspconfig').setup {
        handlers = {
          ...
          -- We only call jdtls once after java setup is done
          jdtls = function()
            -- You do not need to call `require('java').setup()` here again
            -- Just setup the language server
            vim.defer_fn(function()
              require('lspconfig').jdtls.setup {
                -- Your jdtls configurations here
              }
            end, 100)
          end,
        },
